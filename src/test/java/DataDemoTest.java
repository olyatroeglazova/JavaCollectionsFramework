...
public class DataDemoTest {
    ...
    public void iterateAll() {
        Data data = new Data("data", new Group(0,0,1,2,3), new Group(1,4,5), new Group(2, 6));
    ...
    public void iterateWithEmptyGroups() {
        Data data = new Data("data", new Group(0), new Group(1,0,1,2,3), new Group(2), new Group(3, 4,5));
        List<Integer> list = new ArrayList<>();
        for(int i = 0; i<6; i++){
            list.add(i);
        }
